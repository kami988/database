...
int resister_DATA(FILE *fi, node **DATA){
    char c;
    int num;
    int i,j;
    int ex_postal[2], ex_born[3], ex_sex;
    ...
    while(1){
    	...
    	printf("[郵便番号を入力]\n");
    	printf("上三桁:");    			scanf("%d,",&ex_postal[0]);
    	printf("下三桁:");    			scanf("%d,",&ex_postal[1]);
